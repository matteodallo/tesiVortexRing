...
% 0. Data and airfoil
    ...
    h = 0.002;  % element size close to airfoil (later diminished close to LE and TE) 
    airfoil = readmatrix('rR756_refined_openTE.dat'); 

% 1. Boundary Layer Flag (Euler vs RANS)
    % BL=1 --> YES
    % BL=0 --> NO
    BL = 1;
    FAN = 1; % Trailing edge fan (1=YES, 0=NO)
...
fprintf(fileID,'Spline(4)={225:300,1};\n');
